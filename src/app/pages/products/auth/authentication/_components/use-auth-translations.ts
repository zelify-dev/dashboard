...
const AUTH_TRANSLATIONS: Record<Language, AuthTranslations> = {
  en: {
    ...
    preview: {
      ...
      step2Subtitle: "We've sent a 7-digit code to",
      ...
      step4Subtitle: "We've sent a 7-digit code to",
  ...
  es: {
    ...
    preview: {
      ...
      step2Subtitle: "Hemos enviado un código de 7 dígitos a",
      ...
      step4Subtitle: "Hemos enviado un código de 7 dígitos a",
