...
export function TransactionDetail({ transaction, onClose }: TransactionDetailProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div className="relative w-full max-w-2xl rounded-lg border border-stroke bg-white shadow-lg dark:border-dark-3 dark:bg-dark-2" data-tour-id="tour-cards-transactions-detail">
        {/* Header */}
