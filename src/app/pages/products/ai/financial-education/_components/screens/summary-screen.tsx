...
import { PyramidCarousel, type PyramidCarouselItem } from "../ui/pyramid-carousel";
    ...
    en: {
        ...
        metrics: {
            ...
            discipline: {
                title: "Discipline",
                subtitle: "",
                description: "Your consistency in managing finances and following financial goals.",
            },
        },
    },
    es: {
        ...
        metrics: {
            stability: {
                ...
                description: "Transformando tus datos de gastos en insights claros del consumidor, permitiendo decisiones más inteligentes y resultados más efectivos.",
            },
            intelligence: {
                title: "Inteligencia",
                subtitle: "Inteligencia",
            ...
            discipline: {
                title: "Disciplina",
                subtitle: "",
                description: "Tu consistencia en la gestión de finanzas y el seguimiento de objetivos financieros.",
            },
        },
    },
};
                ...
                <div className="flex justify-center gap-3">
                    {[
                        ...
                        <button
                            ...
                            style={{
                                background: "linear-gradient(to bottom, rgba(0, 68, 146, 0.95) 0%, #004492 50%, rgba(0, 51, 102, 0.95) 100%)",
